  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        {/* Form wrapped in Suspense — required by Next.js 14 for useSearchParams */}
        <Suspense fallback={<div className="px-8 py-8 text-center text-sm text-slate-400">Loading…</div>}>
          <LoginForm />
        </Suspense>
      </div>
